const footerHTML = `<footer>
        <div class="footer-left">
            <div class="logo-footer">
                <svg height="58" width="206" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 341.4 93.12">
                    <defs>
                    <style>
                        .cls-1 {
                        fill: #da1c5c;
            ...
            <div class="footer-info">
                <div class="footer-info-company">
                    <p>KILALA COMMUNICATION</p>
                    <p>3rd Floor, Copac Square Building, 12 Ton Dan, Ward 13, District 14, HCMC, VietNam</p>
                    <p>(+84) 902 767 595</p>
                ...
                <div class="footer-info-company">
                    ...
                    <p>kilala.vn</p>
                    <p>biz.feejapan.vn</p>
                    <p>www.kilalashop.com</p>
                    <p>awards.kilala.vn</p>
                    <p>japanguide.kilala.vn</p>
                </div>
            </div>
        </div>
